...
class Block(nn.Module):
    def __init__(self, dim, heads, mlp_dim, dropout, drop_path, search=False):
        super().__init__()
        self.norm1 = nn.LayerNorm(dim)
        self.norm2 = nn.LayerNorm(dim)
        self.attn = Attention(dim, heads, dropout, search=search)
        self.mlp = FeedForward(dim, mlp_dim, dropout, search=search)
